...
Revision ID: aca68b42da96
Revises: 
Create Date: 2019-01-24 15:45:43.512324
...
def upgrade():
    ...
    sa.Column('bodypump', sa.Boolean(), nullable=True),
    sa.Column('calistenics', sa.Boolean(), nullable=True),
