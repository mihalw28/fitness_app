...
class RegistrationForm(FlaskForm):
    ...
    club_site_login = StringField(
        "Email wykorzystywany do logowania na \
                                  stronie siłowni",
        validators=[DataRequired(), Email()],
    )
    club_site_password = PasswordField(
        "Hasło do logowania na stronie siłowni", validators=[DataRequired()]
    )
    password = PasswordField("Hasło", validators=[DataRequired()])
